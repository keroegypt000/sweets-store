...
const productsData = [
  { categoryId: 5, nameAr: 'شوكولاتة داكنة', nameEn: 'Dark Chocolate', price: '2.50', stock: 50, slug: 'dark-chocolate', isFeatured: true },
  { categoryId: 5, nameAr: 'شوكولاتة بالحليب', nameEn: 'Milk Chocolate', price: '2.00', stock: 60, slug: 'milk-chocolate', isFeatured: true },
  { categoryId: 15, nameAr: 'رقائق البطاطس', nameEn: 'Potato Chips', price: '1.50', stock: 100, slug: 'potato-chips' },
  { categoryId: 17, nameAr: 'بسكويت الشوكولاتة', nameEn: 'Chocolate Biscuits', price: '1.75', stock: 80, slug: 'chocolate-biscuits' },
  { categoryId: 26, nameAr: 'قهوة عربية', nameEn: 'Arabic Coffee', price: '3.50', stock: 40, slug: 'arabic-coffee' },
  { categoryId: 28, nameAr: 'لوز محمص', nameEn: 'Roasted Almonds', price: '4.00', stock: 30, slug: 'roasted-almonds' },
  { categoryId: 19, nameAr: 'حلوى التوفي', nameEn: 'Toffee Candy', price: '1.25', stock: 70, slug: 'toffee-candy' },
  { categoryId: 14, nameAr: 'آيس كريم فانيليا', nameEn: 'Vanilla Ice Cream', price: '2.75', stock: 45, slug: 'vanilla-ice-cream' },
  { categoryId: 13, nameAr: 'تمر مجفف', nameEn: 'Dried Dates', price: '3.25', stock: 55, slug: 'dried-dates' },
  { categoryId: 32, nameAr: 'عصير برتقال', nameEn: 'Orange Juice', price: '1.50', stock: 90, slug: 'orange-juice' },
];
...
async function seed() {
  try {
    ...
    for (const prod of productsData) {
      const categoryId = categoryMap.get(prod.categoryId.toString()) || 1;
      await db.insert(products).values({
        ...
        descriptionEn: null,
        originalPrice: null,
        image: 'https://via.placeholder.com/300x300?text=' + encodeURIComponent(prod.nameEn),
        images: null,
        sku: null,
        isActive: true,
        isPromotion: false,
